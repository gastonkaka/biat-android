...
public class AddValidateurFragment extends Fragment {
    ...
    public AddValidateurFragment() {
        // Required empty public constructor
    }


    public static AddValidateurFragment newInstance(String param1, String param2) {
        AddValidateurFragment fragment = new AddValidateurFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view= inflater.inflate(R.layout.fragment_add_validateur, container, false);
    ...
    private void getDepatements() throws JSONException {
        ...
        JsonArrayRequest request=new JsonArrayRequest(url, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                Outils.stopLoading();
                 _deps=response;
                _spinner.setAdapter(new MySpinnerAdapter(response));
            }
    ...
    private JSONObject buildValidateurData()throws JSONException{
        JSONObject data=new JSONObject();
    ...
    private void submitValidateur() throws JSONException {
        Outils.startLoading(getContext());
        JSONObject data=buildValidateurData();
        String url = Uri.parse(DataApplication.URL_BASE + "/validateur.php")
                .buildUpon()
                .appendQueryParameter("data", data.toString())
                .build().toString();
